    ...
    return (
        <section id="about" className="container" style={{ padding: "100px 0" }}>
            <div className="about-content" style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
                <h2 className="animate-text" style={{ marginBottom: "40px", fontSize: "2.5rem" }}>Tentang Saya</h2>
                <p className="animate-text" style={{ fontSize: "1.2rem", lineHeight: "1.8", color: "var(--text-secondary)", marginBottom: "30px" }}>
                ...
                <p className="animate-text" style={{ fontSize: "1.1rem", lineHeight: "1.8", color: "var(--text-secondary)" }}>
                ...
                <div className="animate-text" style={{ marginTop: "40px", padding: "20px", background: "var(--card-bg)", borderRadius: "16px", border: "1px solid var(--glass-border)" }}>
