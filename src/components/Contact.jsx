    ...
    <section id="contact" className="container">
      ...
      <div className="contact-wrapper">
        ...
        <div className="contact-info">
          <h3>Mari Bangun Solusi</h3>
          <p className="desc">
            Saya siap membantu Anda membangun automasi, website, atau sistem AI yang sesuai kebutuhan.
          </p>
          ...
          <div className="info-items">
            <div className="info-item">
              ...
              <div>
                ...
                <div className="value">hello@faishal.dev</div>
              </div>
            </div>
            ...
            <div className="info-item">
              ...
              <div>
                ...
                <div className="value">
                  <a href="#" style={{ color: 'inherit', marginRight: '10px' }}>GitHub</a>
